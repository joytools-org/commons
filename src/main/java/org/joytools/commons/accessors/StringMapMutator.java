 ...
 * @param <V>
 */
public interface StringMapMutator<V> extends FixedSizeStringMapMutator<V>, MapMutator<String, V> {
    
    @Override
    default <Z> StringMapMutator<Z> castAs(final Class<Z> type) {
        return (StringMapMutator<Z>)this;
    }
