 ...
 */
@FunctionalInterface
public interface DelegatedStringMapAccessor<V> extends DelegatedStringAccessor<V>, DelegatedMapAccessor<String, V>, StringMapAccessor<V> {
 
    @Override
    default <Z> DelegatedStringMapAccessor<Z> castAs(final Class<Z> clazz) {
        return (DelegatedStringMapAccessor<Z>)this;
    }
