 ...
 * @param <V>
 */
public interface IndexedStringMapMutator<V> extends StringMapMutator<V>, IndexedMapMutator<String, V> {
    
    @Override
    default <Z> IndexedStringMapMutator<Z> castAs(final Class<Z> type) {
        return (IndexedStringMapMutator<Z>)this;
    }
