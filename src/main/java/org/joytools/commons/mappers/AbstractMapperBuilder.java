 ...
 * @param <O>
 */
public abstract class AbstractMapperBuilder<I, O> implements ComboMapperBuilder<I, O> {
     ...
     * @return 
     */
    protected AbstractMapperBuilder<I, O> mapInput(final Function<? super I, ? extends I> mapper) {
     ...
     * @return 
     */
    protected AbstractMapperBuilder<I, O> mapOutput(final Function<? super O, ? extends O> mapper) {
