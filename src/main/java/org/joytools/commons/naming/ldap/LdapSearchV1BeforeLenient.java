 ...
 * @author AndreaR
 */
public class LdapSearchV1BeforeLenient extends FailableAutoCloseableContainer<NamingException> {

    /**
     * 
     * @param ldapCtxSource 
     */
    protected LdapSearchV1BeforeLenient(final LdapContextSource ldapCtxSource) {
     ...
     * @return 
     */
    public static LdapSearchV1BeforeLenient on(final LdapContextSource ldapCtxSource) {
        return new LdapSearchV1BeforeLenient(ldapCtxSource);
    }
     ...
     * @return 
     */
    public static LdapSearchV1BeforeLenient on(final LdapContext ldapCtx) {
        return new LdapSearchV1BeforeLenient(LdapContextSource.of(ldapCtx));
    }
     ...
     * @return 
     */
    public static LdapSearchV1BeforeLenient on(final LdapContextBuilder ldapCtxBuilder) {
        return new LdapSearchV1BeforeLenient(LdapContextSource.of(ldapCtxBuilder));
    }
     ...
     * @return 
     */
    public LdapSearchV1BeforeLenient requestControls(final Control... controls) {
     ...
     * @return 
     */
    public LdapSearchV1BeforeLenient lenient() {
        this.m_lenient = true;
        return this;
    }
     ...
     * @return 
     */
    public LdapSearchV1BeforeLenient lenient(final boolean flag) {
        this.m_lenient = flag;
        return this;
    }
     ...
     * @return 
     */
    public LdapSearchV1BeforeLenient options(final LdapSearchOptions ldapSearchOpts) {
    ...
    protected EarlyFailableDisposer<NamingEnumeration, NamingException> earlyDisposer() {
        if (earlyDisposer == null) {
            earlyDisposer = new EarlyFailableDisposer(disposer());
        }
        return earlyDisposer;
    }

    private EarlyFailableDisposer<NamingEnumeration, NamingException> earlyDisposer;
