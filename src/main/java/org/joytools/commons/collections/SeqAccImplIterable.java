 ...
 * @param <E> 
 */
abstract class SeqAccImplIterable<E> extends SeqAccImpl<E> {

    protected abstract Iterable<E> delegated();
    ...
    public final boolean contains(final E element) {
        return contains0(element, delegated());
    }
    ...
    public final Stream<E> parallelStream() {
        return StreamSupport.stream(delegated().spliterator(), true);
    }
    ...
    public final boolean isEmpty() {
        return IterableUtils.isEmpty(delegated());
    }
