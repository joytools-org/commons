 ...
 * @author AndreaR
 */
public class PropertyStringsV2BeforeTypedBuilders {
    ...
    public static PropertyString of(final CharSequence text, final CharSequence... elements) {
        return PropertyStringBuilder.of(text, elements).memoized().build();
    }
    ...
    public static PropertyString ofIgnoreCase(final CharSequence text, final CharSequence... elements) {
        return PropertyStringBuilder.ofIgnoreCase(text, elements).memoized().build();
    }
