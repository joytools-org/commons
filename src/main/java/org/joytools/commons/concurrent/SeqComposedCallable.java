 ...
 * @param <V>
 */
public abstract class SeqComposedCallable<V> extends AbstractComposedCallable implements Callable<SeqComposedResult<V>> {
     ...
     * @throws Exception 
     */
    protected SeqComposedResult<V> doCurrentThreadCall() throws Exception {
        final SeqComposedCallableSettings<V> settings = settings();
     ...
     * @throws Exception 
     */
    protected SeqComposedResult<V> doExecutorCall(final Supplier<ExecutorService> ess) throws Exception {
        final SeqComposedCallableSettings<V> settings = settings();
        final Seq<Callable<V>> tasks = settings.tasks();
        final Predicate<ComposedResult<Integer, V>> shutdownPolicy = settings.shutdownPolicy();
