 ...
 * @param <V>
 */
final class SeqComposedResultImpl<V> extends AbstractComposedResultImpl<Integer, V> implements SeqComposedResult<V>  {

    protected SeqComposedResultImpl() {
        m_entriesSeq = Vector.empty();
    }
    
    protected SeqComposedResultImpl(final Vector<Either<Exception, V>> other) {
    ...
    public boolean equals(final Object obj) {
        ...
        final SeqComposedResultImpl<?> other = (SeqComposedResultImpl<?>) obj;
        return Objects.equals(this.m_entriesSeq, other.m_entriesSeq);
    }

    /* protected SeqComposedResultImpl(final SeqComposedResultImpl<V> other) {
    ...
    @Override
    public SeqComposedResult<V> append(final Either<Exception, V> value) {
        Objects.requireNonNull(value, "Value");
        final SeqComposedResultImpl<V> result = new SeqComposedResultImpl<>(m_entriesSeq.append(value));
        return result;
    }

    @Override
    public SeqComposedResult<V> appendAll(final Iterable<Either<Exception, V>> values) {
        Objects.requireNonNull(values, "Values");
        final SeqComposedResultImpl<V> result = new SeqComposedResultImpl<>(m_entriesSeq.appendAll(values));
        return result;
    }
     ...
     */
    @Override
    public void throwIf(final Predicate<? super SeqComposedResult<V>> condition) throws Exception {
     ...
     */
    @Override
    public void throwIf(final Predicate<? super SeqComposedResult<V>> condition,
            final Function<? super SeqComposedResult<V>, ? extends Exception> mapper) throws Exception {
        Objects.requireNonNull(condition, "Condition");
        if (!condition.test(this)) {
            return;
        }
